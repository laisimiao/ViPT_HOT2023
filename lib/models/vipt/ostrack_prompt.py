...
from lib.models.vipt.vit_ce_prompt_vis import vit_base_patch16_224_ce_prompt_vis
from lib.models.vipt.vit_ce_prompt_nir import vit_base_patch16_224_ce_prompt_nir
from lib.models.vipt.vit_ce_prompt_rednir import vit_base_patch16_224_ce_prompt_rednir
from lib.models.vipt.vit_ce_prompt_all import vit_base_patch16_224_ce_prompt_all
...
def build_viptrack(cfg, training=True):
    ...
    if cfg.MODEL.PRETRAIN_FILE and ('OSTrack' not in cfg.MODEL.PRETRAIN_FILE) and ('ViPT' not in cfg.MODEL.PRETRAIN_FILE) and training:
    ...
    if ('OSTrack' in cfg.MODEL.PRETRAIN_FILE or 'ViPT' in cfg.MODEL.PRETRAIN_FILE) and training:
